# Plot the impact of different outsourcing ratios on transportation costs (comparison between suburbs and downtown)
par(mfrow = c(1,1))
...
a <- barplot(draw_data, main="Figure 8 The impact of outsourcing ratio on transportation costs", 
             xlab="Transportation costs (yuan)", ylab="Outsourcing ratio (%)", 
